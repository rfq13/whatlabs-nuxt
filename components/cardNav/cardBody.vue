    ...
    <div class="pb-3">
        <div v-if="mode==`b1`">
            <b-row>
                ...
                <b-col>
                    <div class="float-right">
                        <b-dropdown size="md" dropleft  variant="link" toggle-class="text-decoration-none" class="m-2" no-caret>
                            <template #button-content>
                                <b-icon class="float-right" icon="plus-square-fill" font-scale="1" aria-hidden="true"></b-icon>
                            </template>
            ...
            <b-container fluid="md">
                <b-row class="mb-3">
                    <div v-for="(conv,i) in conversations" :key="i" class="col-lg-6 mt-3">
                        <b-card-group deck>
                            <b-card>
                                <b-row class="mb-3">
                                    <b-col>
                                    ...
                                    <b-col lg="6">
                                        ...
                                        <b-list-group class="mt-2">
                                            <b-list-group-item button v-for="(p,k) in conv.pertanyaan" :key="k" @click="Edit(`${i}|p|${p}`)" class="d-flex justify-content-between align-items-center">
                                                ...
                                                <a href="javascript:void(0)" @click.prevent="Delete(`${i}|p|${p}`)"><i class="fas fa-times-circle"></i></a>
                                            </b-list-group-item>
                                        </b-list-group>
                                    </b-col>
                                    <b-col lg="6">
                                        ...
                                        <b-list-group class="mt-2">
                                            <b-list-group-item button v-for="(p,k) in conv.jawaban" :key="k" @click="Edit(`${i}|j|${p}`)" class="d-flex justify-content-between align-items-center">
                                                ...
                                                <a href="javascript:void(0)" @click.prevent="Delete(`${i}|j|${p}`)"><i class="fas fa-times-circle"></i></a>
                                            </b-list-group-item>
                                        </b-list-group>
                                    </b-col>
                                </b-row>
                ...
                <b-button variant="primary" @click.prevent="cekConv(mode)">Go somewhere</b-button> 
            </b-container>
        ...
        <div v-else-if="mode==`b2`">
            ...
            <b-button variant="warning" @click.prevent="cekConv(mode)">Go somewhere</b-button>
        </div>
        <div v-else>
            ...
            <b-button variant="success" @click.prevent="cekConv(mode)">Go somewhere</b-button>
        </div>
    </div>
</template>
            ...
            if (key != newKey) {
                ...
                if (val) {
                    this.$nextTick(() => {
                        ...
                        this.$set(this.edit,newKey,{pertanyaan:{"":false},jawaban:{"":false}});
                    });
                }
            }
